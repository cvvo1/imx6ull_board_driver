...
void ft5xx6_Init(void)
{
	...
	*/
    ...
    IOMUXC_SetPinConfig(IOMUXC_SNVS_SNVS_TAMPER0_GPIO5_IO00,0xf080);   /*类似led电气属性，输出*/
...
void ft5xx6_touch_coordinate(void)
{
    ...
    for(i=0;i<ft5426_dev.point_num;i++)
    {
        ...
        ft5426_dev.x[i]=(uint16_t)(((one_point[2]&0x0f)<<8) |(one_point[3]));    /*实际x与y相反*/
        ft5426_dev.y[i]=(uint16_t)(((one_point[0]&0x0f)<<8) |(one_point[1]));
